...
export default function Vertrieb() {
  return <main>
    ...
    <section className="desk-cta"><img src={maxDesk} alt="Max Aulbach am Schreibtisch" /><div><p className="eyebrow light">Bereit?</p><h2>Dein nächster Schritt beginnt heute.</h2><a className="button light-button" href={apply}>Jetzt Kontakt aufnehmen →</a></div></section>
