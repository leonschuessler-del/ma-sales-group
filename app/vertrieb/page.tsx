...
export default function Vertrieb() {
  return <main>
    ...
    <section className="sales-hero">
      ...
      <div className="sales-image"><img src="/images/max-desk.jpg" alt="Max Aulbach sitzt am Schreibtisch" /></div>
    </section>
    ...
    <section className="desk-cta"><img src="/images/max-desk.jpg" alt="Max Aulbach am Schreibtisch" /><div><p className="eyebrow light">Bereit?</p><h2>Dein nächster Schritt beginnt heute.</h2><a className="button light-button" href={apply}>Jetzt Kontakt aufnehmen →</a></div></section>
